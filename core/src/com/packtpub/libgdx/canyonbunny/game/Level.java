...
public class Level {
     ...
     * goldCoins - array of all GoldCoin objects in a level
     * feathers - array of a Feather objects in a level
     */
    ...
    /**
     * Initializes the current level. The level file is scanned and objects are loaded according to the 
     * RGB values of the current pixel scanned.
