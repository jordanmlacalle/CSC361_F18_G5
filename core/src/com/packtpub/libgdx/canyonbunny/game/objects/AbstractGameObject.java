...
public abstract class AbstractGameObject 
{
    ...
    //opposing force, slows object until velocity=0. If 0, objects velocity will not decrease
	...
	protected void updateMotionX(float deltaTime)
	{
		...
		//Make sure the object's velocity does not exceed the positive or negative terminal today.
