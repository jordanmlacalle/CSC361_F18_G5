package com.packtpub.libgdx.canyonbunny.game.objects;
   ...
   /**
    * Includes exclusive implementations of necessary operations for carrot functionality
    */
   public class Carrot extends AbstractGameObject {
   private TextureRegion regCarrot;
   
   /**
    * Creates an initialized carrot when called
    */
   public Carrot () {
	   	init();
   		}
   ...
   /**
    * Initializes a carrot with required attributes
    */
   	private void init () {
